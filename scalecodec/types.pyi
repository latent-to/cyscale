...
class MultiAccountId(GenericAccountId):
    ...
    @classmethod
    def create_from_account_list(cls, accounts: list, threshold: int) -> "MultiAccountId": ...
...
class GenericPalletMetadata(Struct):
    ...
    @property
    def errors(self) -> Any: ...
    def get_storage_function(self, name: str) -> Optional["GenericStorageEntryMetadata"]: ...
