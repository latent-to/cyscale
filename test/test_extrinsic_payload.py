...
class TestScaleTypeEncoding(unittest.TestCase):
    ...
    def test_decode_balance_transfer_payload(self):
        ...
        extrinsic = Extrinsic(
            data=ScaleBytes(unsigned_payload), metadata=self.metadata_decoder
        )
        extrinsic.decode()
        ...
        self.assertEqual(
            extrinsic.value["call"]["call_args"][0]["type"], "LookupSource"
        )
        self.assertEqual(
            extrinsic.value["call"]["call_args"][0]["value"],
            "0x586cb27c291c813ce74e86a60dad270609abf2fc8bee107e44a80ac00225c409",
        )

        # Check value of balance transfer
        self.assertEqual(
            extrinsic.value["call"]["call_args"][1]["type"], "Compact<Balance>"
        )
        self.assertEqual(
            extrinsic.value["call"]["call_args"][1]["value"], 1000000000000
        )
    ...
    def test_encode_council_vote_payload(self):
        ...
        self.assertEqual(
            str(payload),
            "0x94040e030123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef0401",
        )
    ...
    def test_encode_democracy_delegate_payload(self):
        ...
        self.assertEqual(
            str(payload),
            "0x90040d0f586cb27c291c813ce74e86a60dad270609abf2fc8bee107e44a80ac00225c40900",
        )
    ...
    def test_encode_democracy_delegate_withconviction_payload(self):
        ...
        self.assertEqual(
            str(payload),
            "0x90040d0f586cb27c291c813ce74e86a60dad270609abf2fc8bee107e44a80ac00225c40905",
        )
    ...
    def test_encode_democracy_external_propose_payload(self):
        ...
        self.assertEqual(
            str(payload),
            "0x8c040d050123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef",
        )
    ...
    def test_encode_democracy_external_propose_default_payload(self):
        ...
        self.assertEqual(
            str(payload),
            "0x8c040d070123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef",
        )
    ...
    def test_encode_democracy_external_propose_majority_payload(self):
        ...
        self.assertEqual(
            str(payload),
            "0x8c040d060123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef",
        )
        ...
        payload = extrinsic.encode(
            {
                ...
                "call_args": {"encoded_proposal": "0x00"},
            }
        )
        ...
        payload = extrinsic.encode(
            {
                ...
                "call_args": {"ref_index": 0, "vote": 128},
            }
        )
    ...
    def test_encode_democracy_reap_preimage_payload(self):
        ...
        self.assertEqual(
            str(payload),
            "0x8c040d140123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef",
        )
    ...
    def test_encode_democracy_remove_proxy_payload(self):
        ...
        self.assertEqual(
            str(payload),
            "0x8c040d0e586cb27c291c813ce74e86a60dad270609abf2fc8bee107e44a80ac00225c409",
        )
    ...
    def test_encode_democracy_set_proxy_payload(self):
        ...
        self.assertEqual(
            str(payload),
            "0x8c040d0c586cb27c291c813ce74e86a60dad270609abf2fc8bee107e44a80ac00225c409",
        )
    ...
    def test_encode_democracy_undelegate_payload(self):
        ...
        payload = extrinsic.encode(
            {"call_module": "Democracy", "call_function": "undelegate", "call_args": {}}
        )
    ...
    def test_encode_democracy_veto_external_payload(self):
        ...
        self.assertEqual(
            str(payload),
            "0x8c040d090123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef",
        )
    ...
    def test_encode_electionsphragmen_remove_member_payload(self):
        ...
        self.assertEqual(
            str(payload),
            "0x90041005ff586cb27c291c813ce74e86a60dad270609abf2fc8bee107e44a80ac00225c409",
        )
    ...
    def test_encode_electionsphragmen_report_defunct_voter_payload(self):
        ...
        self.assertEqual(
            str(payload),
            "0x90041002ff586cb27c291c813ce74e86a60dad270609abf2fc8bee107e44a80ac00225c409",
        )
    ...
    def test_encode_identity_add_registrar_payload(self):
        ...
        self.assertEqual(
            str(payload),
            "0x8c041900586cb27c291c813ce74e86a60dad270609abf2fc8bee107e44a80ac00225c409",
        )
    ...
    def test_encode_identity_kill_identity_payload(self):
        ...
        self.assertEqual(
            str(payload),
            "0x9004190aff586cb27c291c813ce74e86a60dad270609abf2fc8bee107e44a80ac00225c409",
        )
        ...
        payload = extrinsic.encode(
            {
                ...
                "call_args": {"max_fee": 2000000000000, "reg_index": 1},
            }
        )
    ...
    def test_encode_identity_set_account_id_payload(self):
        ...
        self.assertEqual(
            str(payload),
            "0x9004190704586cb27c291c813ce74e86a60dad270609abf2fc8bee107e44a80ac00225c409",
        )
        ...
        payload = extrinsic.encode(
            {
                ...
                "call_args": {"fee": 1000000000000, "index": 1},
            }
        )
    ...
    def test_encode_identity_set_identity_payload(self):
        ...
        self.assertEqual(
            str(payload), "0x6c041901000654657374310654657374320006546573743300000000"
        )
    ...
    def test_encode_registrar_register_para_payload(self):
        ...
        self.assertEqual(
            str(payload),
            "0xe404170004d43593c715fdd31c61141abd04a99fd6822c8558854ccde39a5684e7a56da27d00e1f5050000000000000000000000000104000401",
        )
        ...
        payload = extrinsic.encode(
            {
                ...
                "call_args": {"code": "0x00", "initial_head_data": "0x01"},
            }
        )
        ...
        payload = extrinsic.encode(
            {
                ...
                "call_args": {"duration": 100000, "lease_period_index": 2},
            }
        )
    ...
    def test_encode_slots_set_offboarding_payload(self):
        ...
        self.assertEqual(
            str(payload),
            "0x90041603ff586cb27c291c813ce74e86a60dad270609abf2fc8bee107e44a80ac00225c409",
        )
        ...
        payload = extrinsic.encode(
            {
                ...
                "call_args": {"max_additional": 1000000000000},
            }
        )
        ...
        payload = extrinsic.encode(
            {
                ...
                "call_args": {"era": 1, "slash_indices": [0, 1, 2]},
            }
        )
    ...
    def test_encode_staking_chill_payload(self):
        ...
        payload = extrinsic.encode(
            {"call_module": "Staking", "call_function": "chill", "call_args": {}}
        )
    ...
    def test_encode_staking_force_unstake_payload(self):
        ...
        self.assertEqual(
            str(payload),
            "0x8c04060d586cb27c291c813ce74e86a60dad270609abf2fc8bee107e44a80ac00225c409",
        )
    ...
    def test_encode_staking_nominate_payload(self):
        ...
        self.assertEqual(
            str(payload),
            "0x9404060504ff586cb27c291c813ce74e86a60dad270609abf2fc8bee107e44a80ac00225c409",
        )
    ...
    def test_encode_staking_set_controller_payload(self):
        ...
        self.assertEqual(
            str(payload),
            "0x90040608ff586cb27c291c813ce74e86a60dad270609abf2fc8bee107e44a80ac00225c409",
        )
        ...
        payload = extrinsic.encode(
            {
                ...
                "call_args": {"prefs": {"commission": 100}},
            }
        )
    ...
    def test_encode_system_fill_block_payload(self):
        ...
        payload = extrinsic.encode(
            {"call_module": "System", "call_function": "fill_block", "call_args": {}}
        )
        ...
        payload = extrinsic.encode(
            {
                ...
                "call_args": {"keys": ["0x0123456789abcdef", "0x0123456789abcdef"]},
            }
        )

        self.assertEqual(
            str(payload), "0x5804000508200123456789abcdef200123456789abcdef"
        )
    ...
    def test_encode_technicalcommittee_vote_payload(self):
        ...
        self.assertEqual(
            str(payload),
            "0x94040f030123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef0401",
        )
    ...
    def test_encode_technicalmembership_add_member_payload(self):
        ...
        self.assertEqual(
            str(payload),
            "0x8c041100586cb27c291c813ce74e86a60dad270609abf2fc8bee107e44a80ac00225c409",
        )
    ...
    def test_encode_technicalmembership_change_key_payload(self):
        ...
        self.assertEqual(
            str(payload),
            "0x8c041104586cb27c291c813ce74e86a60dad270609abf2fc8bee107e44a80ac00225c409",
        )
        ...
        payload = extrinsic.encode(
            {
                "call_module": "TechnicalMembership",
                "call_function": "change_key",
                "call_args": {"new": "EaG2CRhJWPb7qmdcJvy3LiWdh26Jreu9Dx6R1rXxPmYXoDk"},
            }
        )
    ...
    def test_encode_technicalmembership_remove_member_payload(self):
        ...
        self.assertEqual(
            str(payload),
            "0x8c041101586cb27c291c813ce74e86a60dad270609abf2fc8bee107e44a80ac00225c409",
        )
    ...
    def test_encode_utility_approve_as_multi_payload(self):
        ...
        payload = extrinsic.encode(
            {
                ...
                "call_args": {
                    ...
                    "maybe_timepoint": {"height": 444, "index": 10},
                    "other_signatories": [
                        "EaG2CRhJWPb7qmdcJvy3LiWdh26Jreu9Dx6R1rXxPmYXoDk"
                    ],
                    "threshold": 4,
        ...
        self.assertEqual(
            str(payload),
            "0x3d01041803040004586cb27c291c813ce74e86a60dad270609abf2fc8bee107e44a80ac00225c40901bc0100000a0000000123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef",
        )
    ...
    def test_encode_utility_as_multi_payload(self):
        ...
        self.assertEqual(str(payload), "0x3c041802050000000001140123456789")
    ...
    def test_encode_utility_batch_payload(self):
        ...
        self.assertEqual(
            str(payload),
            "0xb4041800040400ff586cb27c291c813ce74e86a60dad270609abf2fc8bee107e44a80ac00225c409070010a5d4e8",
        )
    ...
    def test_encode_utility_batch_single_payload_scaletype_v14(self):
        call = self.runtime_config_v14.create_scale_object(
            "Call", metadata=self.metadata_v14_obj
        )
        ...
        extrinsic = self.runtime_config_v14.create_scale_object(
            "Extrinsic", metadata=self.metadata_v14_obj
        )
        ...
        self.assertEqual(
            "0xb404010004060000586cb27c291c813ce74e86a60dad270609abf2fc8bee107e44a80ac00225c409070010a5d4e8",
            str(payload),
        )
        ...
        payload = extrinsic.encode(
            {
                "call_module": "Utility",
                "call_function": "batch",
                "call_args": {"calls": [call, call]},
            }
        )

        self.assertEqual(
            "0x590104010008060000586cb27c291c813ce74e86a60dad270609abf2fc8bee107e44a80ac00225c409070010a5d4e8060000586cb27c291c813ce74e86a60dad270609abf2fc8bee107e44a80ac00225c409070010a5d4e8",
            str(payload),
        )
    ...
    def test_encode_utility_cancel_as_multi_payload(self):
        ...
        payload = extrinsic.encode(
            {
                ...
                "call_args": {
                    ...
                    "other_signatories": [],
                    "threshold": 5,
                    "timepoint": {"height": 10000, "index": 1},
                },
            }
        )
        ...
        self.assertEqual(
            str(payload),
            "0xb804180405000010270000010000000123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef",
        )
    ...
    def test_signed_extrinsic(self):
        ...
        obj = RuntimeConfiguration().create_scale_object(
            "Extrinsic", data=extrinsic_hex, metadata=self.metadata_decoder
        )
        ...
        self.assertEqual(
            extrinsic_value["call"]["call_args"]["dest"],
            decoded_extrinsic["call"]["call_args"][0]["value"],
        )

    def test_decode_mortal_extrinsic(self):
        RuntimeConfiguration().update_type_registry(
            load_type_registry_preset("substrate-node-template")
        )
        ...
        extrinsic = Extrinsic(
            metadata=metadata_decoder, data=ScaleBytes(extrinsic_scale)
        )
        extrinsic.decode()
    ...
    def test_encode_with_bittensor_metadata(self):
        ...
        metadata_decoder = RuntimeConfiguration().create_scale_object(
            "MetadataVersioned",
            data=ScaleBytes(metadata_fixture_dict["bittensor_test"]),
        )
        ...
        extrinsic = runtime_config.create_scale_object(
            "Extrinsic",
            data=ScaleBytes(
                ""
            ),
